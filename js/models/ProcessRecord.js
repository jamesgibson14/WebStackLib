    ...
    var collection = Backbone.Collection.extend({
        ...
        dataRender: function(){
            ...
            return this.map(function(model){
                ...
                var date2 = new Date(2000, 0, 1, e.hh, r.mm); 
                ...
                //alert(date3 + ' ' + date2 + " " + ((date3 - date2)/1000/60))
                line.runTime = (date3 - date2);                
                line.SetupMinutes = (date2 - date1)/1000/60;
                line.downTime = (line.AssignedMinutes-line.runTime-line.SetupMinutes);
                return line;
            })
        },
